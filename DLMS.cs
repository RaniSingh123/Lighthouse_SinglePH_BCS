...
{
    public partial class panelDLMS : Form
    {
        string dataOUT;
        string dataIN;
        string dataTimeStr;
        ...
        //***********************************dlms buttons****************************************//
        #region dlms
        private void btnUnlockDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                dataOUT = "nxpunlock\r";
        ...
        private void btnSetTimeDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
        ...
        private void btnMemEraseDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                dataOUT = "nxpmer\r";
        ...
        private void btnCalPhaseDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                dataOUT = "nxpcalp\r";
        ...
        private void btnCalNeutralDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                dataOUT = "nxpcaln\r";
        ...
        private void btnSetCalUnlockDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                dataOUT = "nxpscall0\r";
        ...
        private void btnGetSrNoDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                dataOUT = "nxpgsr\r";
        ...
        private void btnSetDefaultCalDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                dataOUT = "nxpdcal\r";
        ...
        private void btnSetSrNoDlms_Click(object sender, EventArgs e)
        {
            if (serialPort1.IsOpen)
            {
                dataOUT = "nxpssr" + (Convert.ToString(cTxtSetSrNoDlms.Text)) + "\r";
                serialPort1.WriteLine(dataOUT);
                progressBar2.Value = 0;
            }
        }
